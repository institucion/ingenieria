...
<body>
 ...
 <div class="container colo  formulario">
                     ...
                     <div class="col-lg-2  poscr" style="height:40px; background:#000000;">
...
@if (count($errors) > 0)
            <div class="alert alert-danger" style="margin-top:12%; font-family:Calibri;">
              <ul>
 ...
 <table  id="ubir" class="col-xs-6  col-sm-8 col-md-8  ">

   
         <div class="input-group inpu ubi4 ">
        ...
        <span class="input-group-addon in"> {!! Form::button('Buscar', ['type'=>'submit', 'id'=>'bot']) !!}</span>
         </div>
...
<tr>
  ...
  <tr>
    <td>
         ...
         <div class="input-group in ">
         <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
          {!! Form::text('grupo',$alum[6],['class'=>'form-control', 'placeholder'=>'grupo', 'readonly']) !!}
         </div>
    </td>
