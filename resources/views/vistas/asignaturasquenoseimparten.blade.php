...
<body>
 ...
 <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 ">
      ...
      <h1 class="">Institución Educativa General Santander</h1>
        <h5 class=" p" align="center"  >Asignaturas Que No Se Imparten</h5></center>
  </div>
   ...
   <header class="row visible-md ">
      ...
      <h5 align="center"  >Asignaturas Que No Se Imparten</h5></center>
      ...
      <h5   >Asignaturas Que No Se Imparten</h5></center>
</div>
</header>
...
<div class="container-fluid">
  ...
  <div class="col-md-10">
      <div class="input-group bus">
         ...
         <input type="text" class="form-control" placeholder="Nombre Asignatura" required>
