...
<body>
 ...
 <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 ">
      ...
      <h1 class="">Institución Educativa General Santander</h1>
        <h5 class=" p" align="center"  >Asiganaturas que no se imparten</h5></center>
  </div>
   ...
   <header class="row visible-md ">
      ...
      <h5 align="center"  >Asiganaturas que no se imparten</h5></center>
      ...
      <h5   >Asiganaturas que no se imparten</h5></center>
</div>
</header>
...
<div class="container-fluid ubi4">
  ...
  <div class="col-md-4">
      <div class="input-group ">
         ...
         <input type="text" class="form-control" placeholder="Codigo Asignatura" required>
