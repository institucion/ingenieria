...
<body>
 ...
 <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10 ">
      ...
      <h1 class="">Institución Educativa General Santander</h1>
        <h5 class=" p" align="center"  >Registrar Profesores</h5></center>
  </div>
   ...
   <header class="row visible-md ">
      ...
      <h5 align="center"  >Registrar Profesores</h5></center>
      ...
      <h5   >Registrar Profesores</h5></center>
</div>
</header>
...
<div class="container tama"><p><br></p></div>
        <div class="container-fluid">
      <button type="submit" class="btn btn-primary form-control  atras p" style="color: #000000" onclick="history.back()"> Atras</button>
